...
namespace bdsp
{
	...
	protected:
		...
		void createSyncParameters(juce::AudioProcessorValueTreeState::ParameterLayout& layout, juce::String baseID, const juce::String& baseName, int denominator = -1, int minBeats = 1, int maxBeats = 256, bool ranged = true, bool createLockParameter = false, juce::Array<int> includedDivisions = juce::Array<int>(), int versionHint = 1, int snapVersionHint = -1);
		void createSyncParameters(juce::AudioProcessorValueTreeState::ParameterLayout& layout, juce::String baseID, const juce::String& baseName, float defaultMsTime, float defaultFrac, int defaultDivision, int denominator = -1, int minBeats = 1, int maxBeats = 256, bool ranged = true, bool createLockParameter = false, juce::Array<int> includedDivisions = juce::Array<int>(), int versionHint = 1, int snapVersionHint = -1);

		void createSyncRateParameters(juce::AudioProcessorValueTreeState::ParameterLayout& layout, juce::String baseID, const juce::String& baseName, int minBeats = 1, int maxBeats = 256,int denominator = -1, bool ranged = true, bool createLockParameter = false, juce::Array<int> includedDivisions = juce::Array<int>(), int versionHint = 1, int snapVersionHint = -1);
		void createSyncRateParameters(juce::AudioProcessorValueTreeState::ParameterLayout& layout, juce::String baseID, const juce::String& baseName, float defaultHzRate, float defaultFrac, int defaultDivision, int minBeats = 1, int maxBeats = 256, int denominator = -1, bool ranged = true, bool createLockParameter = false, juce::Array<int> includedDivisions = juce::Array<int>(), int versionHint = 1, int snapVersionHint = -1);
