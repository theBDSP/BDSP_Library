...
namespace bdsp
{
	namespace dsp
	{
		...
		{
			/**
			 * Low-Shelf biquad filter. Formula adapted from: https://www.w3.org/TR/audio-eq-cookbook/
			 */
			template <typename SampleType>
			class LowShelf : public BiQuadBase<SampleType>
			{
			public:
				LowShelf(DSP_Universals<SampleType>* lookupToUse)
